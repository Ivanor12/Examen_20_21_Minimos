     ...
     <div class="postcontent">
      <h2>Calculadora Harris-Benedict   </h2>
              <form action="Solucion_Ejercicio.php" method="post">              
                        ...
                        <table align="center" border="2">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number"   id="txt_peso" name="txt_peso" size="7" /> 
                                </td>
                            </tr>
                            <tr>
                                <td ></td>
                            ...
                            <tr>
                               ...
                               <td>
                                 <input type="number"   id="txt_altura" name="txt_altura" size="7" /> cm
                               </td>
                            </tr>
                            <tr>
                            ...
                            <td>
                                ...
                                <input type="number"   id="txt_edad" name="txt_edad" size="7" /> Años
                            </td>
                        </tr>
                            <tr>
                    ...
                    <input type="text" id="txt_calorias" name="txt_calorias" size="5" value=" '.$resultado.'" /> calorias
